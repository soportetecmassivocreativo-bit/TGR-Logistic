          ...
          <div className={styles.blockVisual}>
            <div className={styles.mapCard}>
              ...
              <div className={styles.routeDots}>
                ...
                <span className={styles.dot} style={{top:'60%', left:'40%'}} />
                <span className={styles.dot} style={{top:'45%', left:'20%'}} />
                <span className={styles.dot} style={{top:'70%', left:'65%'}} />
                <svg className={styles.routeLines} viewBox="0 0 300 200">
                  <polyline points="90,40 165,70 120,120 60,90 195,140" fill="none" stroke="#d4ff00" strokeWidth="1.5" strokeDasharray="6 4" opacity="0.6"/>
                </svg>
              </div>
            </div>
          </div>
